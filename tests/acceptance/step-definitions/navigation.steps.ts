...
When<CustomWorld>('I navigate the site using only a keyboard', async function () {
  // Start from top of page
  await this.page.keyboard.press('Tab')
})

Then<CustomWorld>('I can reach every link and interactive element via Tab key', async function () {
...
Then<CustomWorld>('the Interactive Solver can be fully operated by keyboard', async function () {
...
Then<CustomWorld>('all text content is readable without horizontal scrolling', async function () {
...
When<CustomWorld>('I visit the History, Lesson, or Examples pages', async function () {
...
Then<CustomWorld>('I see a list of terms in alphabetical order', async function () {
...
When<CustomWorld>('I click the inline glossary link for a term', async function () {
...
Then<CustomWorld>('no glossary link points to a missing or empty entry', async function () {
